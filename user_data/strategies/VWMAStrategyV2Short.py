...
class VWMAStrategyV2Short(IStrategy):
    """
    VWMA Strategy V2 Implementation - Short Only
    ...
    # Stoploss - IMPROVED: Standardized range for better risk management
    ...
    # Custom stoploss space for 1-5% range (same as long strategy)
    class HyperOpt:
        @staticmethod
        def stoploss_space():
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        """
        Populate indicators for VWMA short strategy V2
