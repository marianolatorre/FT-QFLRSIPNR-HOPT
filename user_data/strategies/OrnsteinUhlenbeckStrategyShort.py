...
class OrnsteinUhlenbeckStrategyShort(IStrategy):
    """
    Ornstein-Uhlenbeck Mean Reversion Strategy (Short Only)
    """
    ...
    # Hyperopt parameters
    lookback_period = IntParameter(20, 400, default=100, space='sell')
    entry_threshold = DecimalParameter(1.0, 4.0, default=2.0, space='sell', decimals=1)
    exit_threshold = DecimalParameter(0.0, 2.0, default=0.5, space='sell', decimals=1)
    half_life_period = IntParameter(5, 200, default=21, space='sell')
    ...
    plot_config = {
        ...
        'subplots': {
            ...
            'Z-Score': {
                'z_score': {'color': '#ff0000', 'type': 'line'},
            },
        }
    }
