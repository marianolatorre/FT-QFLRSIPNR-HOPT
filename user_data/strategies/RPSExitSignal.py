...
class RPSExitSignal(IStrategy):
    """
    RSI PNR Slope Strategy - Exit Signal Version
    ...
    # Sell space parameters (exit signal) - independent optimization
    sell_rsi_lookback = IntParameter(5, 20, default=10, space='sell')
    ...
    plot_config = {
        ...
        'subplots': {
            ...
            'RSI PNR Sell (Exit)': {
                ...
                'rsidiffMAX_threshold': {'color': '#ff6600', 'type': 'line'},
            },
            'VWMA Slow Slope': {
            ...
            'Long Signals': {
                ...
                'rsi_pnr_sell_signal': {'color': '#ff0000', 'type': 'scatter'},
            }
        }
    }
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        """
        Exit logic: RSI PNR sell signal with independent sell space parameters
        """
        ...
        # Calculate crossover signals for sell
        ...
        # Exit on RSI PNR sell signal
        dataframe.loc[dataframe['rsi_pnr_sell_signal'], 'exit_long'] = 1
